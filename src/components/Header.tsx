              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                    <div className="py-2">
                      <Link href="/user/profile" className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
                        Profile
                      </Link>
                      <Link href="/user/coupons" className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
                        My Coupons
                      </Link>
                      <button
            ...
            <div className="space-y-4">
              ...
              {session ? (
                <>
                  ...
                  <Link href="/user/profile" className="block text-gray-600 hover:text-gray-900">
                    Profile
                  </Link>
                  <Link href="/user/coupons" className="block text-gray-600 hover:text-gray-900">
                    My Coupons
                  </Link>
                  <button
                    onClick={handleSignOut}
